#!/usr/bin/env python3
"""
360-Degree Functional Test for borang.html (LIVE VERSION)
Tests: Form submission, EmailJS delivery, PDF generation, Supabase insert
Testing against LIVE GitHub Pages URL
"""
...
def test_borang_live():
    ...
    with sync_playwright() as p:
        ...
        print(f"=== 360-Degree Test: borang.html (LIVE) ===\n")
        print(f"Opening: {url}")
        page.goto(url)
        ...
        def log_console(msg):
            ...
            if 'email' in text.lower() or 'error' in text.lower() or 'supabase' in text.lower():
        ...
        print("\n=== Test Summary ===")
        print("✅ Form submission test completed on LIVE URL")
