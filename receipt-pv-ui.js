...
function showReceiptsPage() {
  ...
  if (!container) return;
  container.innerHTML = `
    <div class="sec-card" style="border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--card); box-shadow: var(--shadow-xs);">
      <div class="sec-head" style="padding: 12px 16px; border-bottom: 1px solid var(--border); background: var(--muted)/20;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          <div>
            <h3 style="color: var(--foreground); margin: 0; font-size: 14px; font-weight: 600;">JANA RESIT BAYARAN</h3>
          </div>
        </div>
      </div>
      <div class="sec-body" style="padding: 16px;">
        <div style="display: grid; grid-template-columns: 2fr 140px auto auto; gap: 12px; margin-bottom: 12px; align-items: end;">
          ...
          <div class="checkbox-wrapper" style="display: flex; align-items: center; padding: 0 6px;">
        ...
        <div style="display: grid; grid-template-columns: auto auto 1fr auto; gap: 12px; margin-bottom: 12px; align-items: end;">
          <div class="field-grp" style="display: flex; align-items: center; padding-bottom: 10px;">
            <label class="field-label" style="font-weight: 500; color: var(--foreground); margin: 0; font-size: 12px;">Kaedah Pembayaran</label>
          </div>
          <div class="checkbox-wrapper" style="display: flex; align-items: center; padding: 0 6px;">
        ...
        <div style="background: var(--muted)/10; border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; margin-bottom: 12px;">
          <small style="color: var(--muted-foreground); font-size: 11px; display: block; line-height: 1.4;">Muat naik imej atau PDF slip pembayaran. Fail ini akan disimpan sebagai bukti pembayaran dan diproses dengan OCR.</small>
        </div>
        
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
          <div class="field-grp">
            <label class="field-label" style="font-weight: 500; color: var(--foreground); margin-bottom: 6px; display: block; font-size: 12px;">Ahli (untuk yuran keahlian)</label>
            <select id="receipt-member-select" class="field-input" style="padding: 8px 12px; border: 1px solid var(--border); border-radius: var(--radius-sm); background: var(--background); font-size: 12px;">
        ...
        <div class="field-grp input-wrapper" style="margin-bottom: 12px;">
        ...
        <div id="ocr-status" class="alert" style="display: none; padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 12px; font-size: 12px;">
          <span id="ocr-status-text"></span>
        </div>
        
        <div id="transaction-id-display" class="alert alert-ok" style="display: none; padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 12px; background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.3); font-size: 12px;">
          <strong style="color: var(--success);">ID Transaksi:</strong> <span id="transaction-id-text" style="font-weight: 500;"></span>
        </div>
        
        <div style="display: flex; justify-content: flex-end; gap: 8px;">
          <button onclick="handleGenerateReceipt()" class="btn-pill" style="padding: 8px 20px; font-size: 12px; font-weight: 500;">Jana Resit</button>
        </div>
      </div>
    </div>
  ...
  container.innerHTML = `
    <div class="sec-card" style="border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--card); box-shadow: var(--shadow-xs);">
      <div class="sec-head" style="padding: 12px 16px; border-bottom: 1px solid var(--border); background: var(--muted)/20;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          <div>
            <h3 style="color: var(--foreground); margin: 0; font-size: 14px; font-weight: 600;">CIPTA BAUCAR PEMBAYARAN</h3>
          </div>
        </div>
      </div>
      <div class="sec-body" style="padding: 16px;">
        ...
        <div class="field-grp input-wrapper" style="margin-bottom: 12px;">
          <textarea id="voucher-purpose" class="field-input floating-input" rows="2" placeholder=" "></textarea>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 8px;">
          <button onclick="createPaymentVoucher()" class="btn-pill" style="padding: 8px 20px; font-size: 12px; font-weight: 500;">Cipta Baucar</button>
        </div>
      </div>
    </div>
  ...
  container.innerHTML = `
    <div class="sec-card" style="border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--card); box-shadow: var(--shadow-xs);">
      <div class="sec-head" style="padding: 12px 16px; border-bottom: 1px solid var(--border); background: var(--muted)/20;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          <div>
            <h3 style="color: var(--foreground); margin: 0; font-size: 14px; font-weight: 600;">KELULUSAN TERTUNDA</h3>
          </div>
        </div>
      </div>
      <div class="sec-body" style="padding: 16px;">
        <div class="table-wrap" style="border-radius: var(--radius-sm); overflow: hidden; border: 1px solid var(--border);">
          <table class="table" style="margin: 0;">
            <thead style="background: var(--muted)/30;">
              <tr>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Nombor Baucar</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Tarikh</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Dibayar Kepada</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Tujuan</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Jumlah</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Disediakan Oleh</th>
                <th style="color: var(--foreground); font-weight: 500; padding: 8px 12px; font-size: 11px; letter-spacing: 0.3px;">Tindakan</th>
              </tr>
            </thead>
            <tbody id="approvals-table-body">
              <tr>
                <td colspan="7" style="text-align: center; color: var(--muted-foreground); padding: 24px 12px; font-size: 12px;">Memuatkan kelulusan...</td>
              </tr>
            </tbody>
          </table>
        </div>
